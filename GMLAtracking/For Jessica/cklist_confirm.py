...
def tweak_cklist_issue(df):
    ...
    .astype({"projectSizeId":'int16',"Phase":"category","Risk":"category"})
    .sort_values('Risk')
...
def tweak_project_schedule(df):
    ...
    .astype({"projectSizeId":'int16',"DESC_OF_TASK":"category","Phase":'category'})
...
def tweak_gmla_cklist(df):    
    ...
    .astype({"projectSizeId":'int16',"Phase":"category","Score":"float16"})
    )
#%%
