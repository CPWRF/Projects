...
# %%
testresult = pd.read_excel('AsiaPR.xlsx',sheet_name='Test Result')
# %%
...
# %%
raw = pd.read_excel('asia_raw.xlsx')
...
# %%
my_hisplot(raw,16516,63,-20,"CT_GPS L5 Radiated Sensitivity (S70)_15.38%");
# %%
my_hisplot(raw,16516,70,-20,"CT_GPS L1 Radiated Sensitivity (S70)_12.82%");
# %%
my_hisplot(raw,16521,115,-20,"FT1_GPS L5 Radiated Sensitivity (S70)_11.82%");
# %%
my_hisplot(raw,16518,115,-20,"RT1_GPS L5 Radiated Sensitivity (S70)_11.3%");