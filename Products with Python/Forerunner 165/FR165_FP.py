...
# %%
testresult = pd.read_excel('FR165_FP.xlsx',sheet_name='Test Result')
# %%
...
# %%
my_hisplot(raw,16518,89,-20, 'RT1_GPS L1 Radiated Sens (S70s)');
ppk_result(ppk_df(raw,16518,89), lower=-3, upper=3)