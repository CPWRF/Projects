...
# %%
testresult = pd.read_excel('Descent S1_FFP_45.xlsx',sheet_name='Test Result')
# %%
...
def tweak(df):
    ...
    .rename(columns = lambda col : col.replace(" ",'').replace('/','').replace('%',''))
...
# %%
raw = pd.read_excel('Descent S1_FFP_raw.xlsx')
# %%
...
CT = 13602
# %%
my_hisplot_SQL(raw, FT1, 85, -30, "Dive_humidity diff")
# %%
